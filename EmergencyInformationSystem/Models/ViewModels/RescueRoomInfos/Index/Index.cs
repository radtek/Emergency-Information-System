...
namespace EmergencyInformationSystem.Models.ViewModels.RescueRoomInfos.Index
{
    ...
    public class Index
    {
        ...
        public Index(DateTime? inDepartmentTimeStart, DateTime? inDepartmentTimeEnd, DateTime? outDepartmentTimeStart, DateTime? outDepartmentTimeEnd, int? greenPathCategoryId, bool? isRescue, bool? isLeave, string patientName, string outPatientNumber, int page, int perPage)
        {
            ...
            this.Route = new Route(inDepartmentTimeStart, inDepartmentTimeEnd, outDepartmentTimeStart, outDepartmentTimeEnd, greenPathCategoryId, isRescue, isLeave, patientName, outPatientNumber, page, perPage, query.Count());
