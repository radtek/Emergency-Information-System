...
namespace EmergencyInformationSystem.Models.ViewModels.RescueRoomInfos.Edit
{
    ...
    {
        public Edit(Models.Domains.Entities.RescueRoomInfo target)
        {
            ...
            this.InRescueRoomWayId = target.InRescueRoomWayId;
            this.InRescueRoomWayRemarks = target.InRescueRoomWayRemarks;
