...
namespace EmergencyInformationSystem.Models.ViewModels.RescueRoomInfos2.Index
{
    public class Index
    {
        public Index(Route route)
        {
            ...
            var query = db3.GeneralRoomInfos.Where(c => c.Room.IsRescueRoom);
        ...
        //    var query = db2.GeneralRoomInfos.Where(c => (c.Room.RoomCode & Domains2.Entities.RoomCode.RescueRoom) == Domains2.Entities.RoomCode.RescueRoom);
