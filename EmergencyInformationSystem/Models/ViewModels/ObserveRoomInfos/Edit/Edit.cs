...
namespace EmergencyInformationSystem.Models.ViewModels.ObserveRoomInfos.Edit
{
    public class Edit : IValidatableObject
    {
        ...
        [Display(Name = "入室方式")]
        public Guid? InObserveRoomWayId { get; set; }
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            //2.入室方式必填。
            if (!this.InObserveRoomWayId.HasValue)
            ...
            if (this.InObserveRoomWayId.HasValue && db.InObserveRoomWays.Find(this.InObserveRoomWayId).IsHasAdditionalInfo && string.IsNullOrWhiteSpace(this.InObserveRoomWayRemarks))
