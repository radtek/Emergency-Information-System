...
namespace EmergencyInformationSystem.Models.ViewModels.ObserveRoomInfos2.Index
{
    ...
    {
        public Route(DateTime? inDepartmentTimeStart, DateTime? inDepartmentTimeEnd, DateTime? outDepartmentTimeStart, DateTime? outDepartmentTimeEnd, bool? isLeave, string patientName, string outPatientNumber, Guid? inRoomWayId, Guid? destinationId, int page, int perpage, int count) : base(page, perpage, count)
        {
        ...
        {
            return new Route(this.InDepartmentTimeStart, this.InDepartmentTimeEnd, this.OutDepartmentTimeStart, this.OutDepartmentTimeEnd, this.IsLeave, this.PatientName, this.OutPatientNumber, this.InRoomWayId, this.DestinationId, page, this.PerPage, this.Count);
        }
    }
}